$(function() {
  $(document).ready(function() {
    $('.post-editor').sceditor({
      ...
      fonts: 'Arial,Arial Black,Comic Sans MS,Courier New,Georgia,Impact,Open Sans,Montserrat,Sans-serif,Serif,Storybook,Times New Roman,Trebuchet MS,Verdana,Winterland',
      autoExpand: true,
