...
SHOUTBOX_MINIMUM_POSTS = SETTINGS_OVERRIDES.get(
...
PRIVATE_MESSAGING_ENABLED = SETTINGS_OVERRIDES.get(
    'PRIVATE_MESSAGING_ENABLED', True
)

GRAVATAR_SUPPORT_ENABLED = SETTINGS_OVERRIDES.get(
    'GRAVATAR_SUPPORT_ENABLED', True
)

USERNAME_MODIFIERS_DISABLED_TAGS = SETTINGS_OVERRIDES.get(
